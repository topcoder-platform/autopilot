...
public class ActiveAutoPilotSourceFailureTests extends FailureTestsHelper {
    ...
    public void testConstructor3Null1() {
        try {
            new ActiveAutoPilotSource(null, "a", "b", "c", LogManager.getLog());
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // ok
        }
    ...
    public void testConstructor3Null2() {
        try {
            ...
            new ActiveAutoPilotSource(projectManager, null, "b", "c", LogManager.getLog());
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // ok
        }
    ...
    public void testConstructor3Null3() {
        try {
            ProjectManager projectManager = new MockProjectManager();
            new ActiveAutoPilotSource(projectManager, "a", null, "c", LogManager.getLog());
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // ok
        }
    ...
    public void testConstructor3Null4() {
        try {
            ProjectManager projectManager = new MockProjectManager();
            new ActiveAutoPilotSource(projectManager, "a", "b", null, LogManager.getLog());
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // ok
        }
    ...
    public void testConstructor3EmptyString1() {
        try {
            ProjectManager projectManager = new MockProjectManager();
            new ActiveAutoPilotSource(projectManager, "", "b", "c", LogManager.getLog());
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // ok
        }
    ...
    public void testConstructor3EmptyString3() {
        try {
            ProjectManager projectManager = new MockProjectManager();
            new ActiveAutoPilotSource(projectManager, "a", "", "c", LogManager.getLog());
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // ok
        }
    ...
    public void testConstructor3EmptyString5() {
        try {
            ProjectManager projectManager = new MockProjectManager();
            new ActiveAutoPilotSource(projectManager, "a", "b", "", LogManager.getLog());
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // ok
        }
